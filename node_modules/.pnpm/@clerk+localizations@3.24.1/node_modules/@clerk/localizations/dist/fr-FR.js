...
var frFR = {
  ...
  badge__you: "Vous",
  commerce: {
    addPaymentMethod: "Ajouter une m\xE9thode de paiement",
    ...
    cancelSubscriptionAccessUntil: "Acc\xE8s annul\xE9 jusqu'au",
    ...
    pastDue: void 0,
    pay: "Payer {{amount}}",
    paymentMethods: "M\xE9thodes de paiement",
    paymentSource: {
      applePayDescription: {
    ...
    billingPage: {
      ...
      paymentSourcesSection: {
        ...
        removeResource: {
          ...
          successMessage: "{{paymentSource}} a \xE9t\xE9 supprim\xE9 de votre compte.",
