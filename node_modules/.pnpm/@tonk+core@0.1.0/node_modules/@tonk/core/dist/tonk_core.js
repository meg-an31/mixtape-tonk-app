 ...
 * @returns {Promise<any>}
 */
export function create_sync_engine() {
 ...
 * @returns {Promise<any>}
 */
export function create_sync_engine_with_peer_id(peer_id) {
...
const WasmRepoFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
export class WasmRepo {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WasmRepo.prototype);
        obj.__wbg_ptr = ptr;
...
const WasmSyncEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
export class WasmSyncEngine {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WasmSyncEngine.prototype);
        obj.__wbg_ptr = ptr;
     ...
     * @returns {Promise<any>}
     */
    connectWebsocketWithServerRoot(url) {
        const ptr0 = passStringToWasm0(url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmsyncengine_connectWebsocketWithServerRoot(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    constructor() {
...
const WasmVfsFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
export class WasmVfs {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WasmVfs.prototype);
        obj.__wbg_ptr = ptr;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper517 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 272, __wbg_adapter_32);
        return ret;
    };
