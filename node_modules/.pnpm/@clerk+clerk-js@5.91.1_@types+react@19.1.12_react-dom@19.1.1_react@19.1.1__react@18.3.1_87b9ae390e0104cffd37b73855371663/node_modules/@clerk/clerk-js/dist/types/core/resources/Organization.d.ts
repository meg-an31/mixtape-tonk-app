import type { AddMemberParams, ClerkPaginatedResponse, ClerkResourceReloadParams, CommerceSubscriptionItemResource, CreateOrganizationParams, GetDomainsParams, GetInvitationsParams, GetMembershipRequestParams, GetMemberships, GetRolesParams, GetSubscriptionsParams, InviteMemberParams, InviteMembersParams, OrganizationDomainResource, OrganizationInvitationResource, OrganizationJSON, OrganizationJSONSnapshot, OrganizationMembershipRequestResource, OrganizationResource, SetOrganizationLogoParams, UpdateMembershipParams, UpdateOrganizationParams } from '@clerk/types';
...
export declare class Organization extends BaseResource implements OrganizationResource {
    ...
    getSubscriptions: (getSubscriptionsParams?: GetSubscriptionsParams) => Promise<ClerkPaginatedResponse<CommerceSubscriptionItemResource>>;
