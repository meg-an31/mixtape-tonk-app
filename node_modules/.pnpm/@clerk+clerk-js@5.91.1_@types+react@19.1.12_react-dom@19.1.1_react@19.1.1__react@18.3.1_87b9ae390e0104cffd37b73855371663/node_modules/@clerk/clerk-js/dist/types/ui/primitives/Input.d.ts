...
export declare const DivInput: React.ForwardRefExoticComponent<Omit<DivInputProps, "ref"> & React.RefAttributes<HTMLDivElement>>;
export declare const CheckboxInput: React.ForwardRefExoticComponent<Omit<InputProps, "ref"> & React.RefAttributes<HTMLInputElement>>;
export declare const RadioInput: React.ForwardRefExoticComponent<Omit<InputProps, "ref"> & React.RefAttributes<HTMLInputElement>>;
