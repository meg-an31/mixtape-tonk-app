...
const startDockerizedServer = async () => {
    try {
        ...
        if (!fs.existsSync(persistencePath)) {
            ...
            console.log(chalk.blue(`Created persistence directory: ${persistencePath}`));
        }
        ...
        console.log(chalk.cyan('   Persistence path:'), chalk.bold.green(persistencePath));
